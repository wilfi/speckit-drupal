---
name: speckit-drupal-verify-quality
description: Verify Drupal extension quality rules — performance, smoke, libraries,
  JS, and accessibility
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: drupal:commands/speckit.drupal.verify-quality.md
---
...
## Rules (see `.specify/templates/drupal-quality-rules.md`)

| Rule | Requirement |
|------|-------------|
| **QR-PERF-001** | Page load ≤ 2 seconds (configurable) |
| **QR-SMOKE-001–007** | HTTP 200, forbidden strings, content markers, no duplicate nav text or href, Figma nav active state, search icon markup |
...
| **QR-ASSET-001–004** | Images and static assets reachable per page/component scope; format integrity |
